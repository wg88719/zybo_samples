...
#define MS_COUNTER_WAIT   49 // wait for 100, 10ms intervals
#define HALF_SECOND_WAIT  24  // wait for 50 10ms intervals
#define TENTH_SECOND_WAIT 4  // wait for 10 10ms intervals
